...
###Load data ###
Count_matrix_cesc <- vroom::vroom(file = "~/2_Prepro_Data_TCGA/A7_A9/Final_A7_A9_Annot.tsv")
...
metadata <- vroom::vroom(file = "~/2_Prepro_Data_TCGA/A7_A9/Factors_A7_A9.tsv")
head(metadata)
...
Full_rac1 <- metadata_rac1 %>% left_join(clinical_cesc, by = c("cases.submitter_id" = "bcr_patient_barcode"))
